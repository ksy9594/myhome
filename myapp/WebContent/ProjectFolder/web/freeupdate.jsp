<%@ page contentType="text/html; charset=UTF-8" %><!-- 자유게시판 수정 -->
...
<body>
<form name = "updateFrm" action = "freeupdateProc.jsp" method = "post" enctype="multipart/form-data">	
	...
	<input type="hidden" name="nowPage" value="<%=nowPage%>">
 	...
 	<input type="hidden" name="flag" value="freeupdate">
</form>
