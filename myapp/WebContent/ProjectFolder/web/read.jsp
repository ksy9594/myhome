...
<%
	  ...
	  if(cookies != null && cookies.length >0) //쿠기가 존재여부 체크
	  {
		  for(int i = 0; i <cookies.length; i++)
		  {
			  if(cookies[i].getName().equals("Cookieview")) //쿠키가 같냐 안같냐 체크
			  {
				  Cookieview = cookies[i]; //같으면 변수에 값을 입력
			  }				  
		  }
	  }
	 ...
	 if(Cookieview == null)
	 {
		 ...
		 Cookie newCookie = new Cookie("Cookieview","|"+num+"|");
	 ...
	 else
	 {
		 ...
		 if(value.indexOf("|"+num+"|") <0)
		 {
			 ...
			 System.out.println(Cookieview.getValue());
...
<table align="center" width="70%" border=0 cellspacing="3" cellpadding="0">
 ...
 <tr>
   ...
   <tr> 
    <td colspan="4"><br/>
    <img src = "fileuploadimg/<%=filename%>" width="100%" height="auto">
    <pre>    
    <%=content%>
    </pre><br/></td>
   </tr>
   ...
   <tr>
   <td>
    <a href="recommandProc.jsp?nowPage=<%=nowPage%>&num=<%=num%>">
    <input type = "button" class="btn btn-primary pull-right" value="추천하기"></a>
    </td>
   </tr>
   </table>
  </td>
 ...
 <a href="updatepwd.jsp?nowPage=<%=nowPage%>&num=<%=num%>" style = "text-decoration:none; color:black;">수 정</a> |
 <a href="delete.jsp?nowPage=<%=nowPage%>&num=<%=num%>" style = "text-decoration:none; color:black;">삭 제</a> ]<br>
  </td>
 </tr>
</table>
