    ...
    function html5Upload() {	
    	...
    	sUploadURL = '/myapp/ProjectFolder/web/file_uploader_html5.jsp' //upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/myapp/ProjectFolder/web/file_uploader.jsp',
 	    	sCallback : '/myapp/ProjectFolder/web/quick_photo_uploader/popup/callback.html',
